...
- **Scope-resolution responsiveness on large monorepos** — preserve cooperative event-loop yields through reference resolution and edge-emission passes so progress, incremental GC, and errors remain observable at multi-million-site scale.
