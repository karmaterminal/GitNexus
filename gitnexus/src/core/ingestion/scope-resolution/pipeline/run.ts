...
export async function runScopeResolution(
  ...
  // Most providers have consumed their source snapshot by this point. Keep it
  // only when the final post-resolution hook still needs source text.
